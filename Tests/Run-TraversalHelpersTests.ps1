<#
.SYNOPSIS
    Wrapper script to run TraversalHelpers tests with proper module loading.
...
# Run Pester
$result = Invoke-Pester -Path "$PSScriptRoot\TraversalHelpers.Tests.ps1" -Output Detailed -PassThru
