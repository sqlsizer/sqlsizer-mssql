<#
.SYNOPSIS
    Wrapper script to run TypeAccess tests with proper module loading.
...
Write-Host "Running TypeAccess tests..." -ForegroundColor Cyan

# Run Pester
$result = Invoke-Pester -Path "$PSScriptRoot\TypeAccess.Tests.ps1" -Output Detailed -PassThru
