...
while ($true)
{
    ...
    $result = Find-RemovalSubset -Database $database -ConnectionInfo $connection -DatabaseInfo $info -SessionId $sessionId -MaxBatchSize 10000 -StartIteration $startIteration  
